...
# for css in base prettify ; do ./scripts/replace-css-colors.pl scripts/$css.orig.css > coverage/lcov-report/$css.css; done ;  vdiff scripts/base.orig.css coverage/lcov-report/base.css
my %remap = (
	"#000" => "#fff",
#	"#006" => "#ff9",
#	"#0074d9" => "#ff8b26",
...
#	"#e8e8e8" => "#171717",
	"#eaeaea" => "#151515",
#	"#eee" => "#111",
	"#f6c6ce" => "#470b15",#"#093931",
	"#fce1e5" => "#031e1a",
#	"green" => "#f0f",
#	"red" => "#0ff",
#	"rgb(161,215,106" => "rgb(94, 40, 149",
	"rgb(230,245,208" => "rgb(31,12,59",#"rgb(25, 10, 47",
